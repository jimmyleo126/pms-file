...
public class TableCreationUtil {
	...
	private static final String SRC_FILE = "table.xlsx";

	private static final String TAR_FILE = "table.sql";

	private static final String DATA_TABLESPACE = "PMS_DAT";
	
	private static final String INDEX_TABLESPACE = "PMS_IDX";
