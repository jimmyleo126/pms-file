...
public class WorkService extends GenericDAOImpl{
    ...
    public List<?> getworkbillLog(String workbillid, Pagination paginatin) {
		...
		"    '；备注，新值：' || nvl(r.remark,'')) content from TL_P_RECORDING r where r.record_type = '2' and r.check_id= '"+ workbillid + "' order by r.record_time desc";
	...
	public void updateworkbill(String name, String describe, String workbillId){
		...
		this.executeUpdateHQL(hql, new String[]{"NAME", "DESCRIBE", "WORKBILLID"}, new Object[]{name, describe, workbillId});
	}
