...
public class WeatherController {
	...
	public void getWeatherInfo(String cityId, HttpServletResponse response) throws Exception {
		String message = "";
		JSONObject result;
		String cityUrl = "http://nanjing.tianqi.com";
		...
		try {
			...
			BufferedReader in = new BufferedReader(new InputStreamReader(connect.getInputStream(), "GBK"));
			String line = null;
			StringBuffer scont = new StringBuffer();
