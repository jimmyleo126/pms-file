 ...
 * 
 */
@WebServiceClient(name = "DataDealPortalService", targetNamespace = "http://portal.ideassoft.com", wsdlLocation = "http://localhost:8080/cdds/ws/call?wsdl")
	...
	static {
		...
		try {
			...
			baseUrl = com.ideassoft.portal.DataDealPortalService.class
					.getResource(".");
			url = new URL(baseUrl, "http://localhost:8080/cdds/ws/call?wsdl");
		} catch (MalformedURLException e) {
			logger.warning("Failed to create URL for the wsdl Location: 'http://localhost:8080/cdds/ws/call?wsdl', retrying as a local file");
