...
public class SqlInfo implements java.io.Serializable {
	...
	/** minimal constructor */
	public SqlInfo(Integer dataId, String sqlName, String sqlInfo, String dbType) {
		this.dataId = dataId;
	...
	/** full constructor */
	public SqlInfo(Integer dataId, String sqlName, String sqlInfo, String dbType, String remark) {
		this.dataId = dataId;
		this.sqlName = sqlName;
		this.sqlInfo = sqlInfo;
		this.dbType = dbType;
