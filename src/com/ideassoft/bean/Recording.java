...
public class Recording implements java.io.Serializable {
	...
	/** minimal constructor */
	public Recording(String recordId, String branchId, String checkId, String recordType, String projectId,
			Double fee, String recordUser) {
	...
	/** full constructor */
	public Recording(String recordId, String branchId, String checkId, String recordType, String projectId,
			Double fee, Date recordTime, String recordUser, String remark) {
		this.recordId = recordId;
		this.branchId = branchId;
		this.checkId = checkId;
		this.recordType = recordType;
	...
	@Column(name = "CHECK_ID",  length = 16)
