...
public class CouponGroup implements java.io.Serializable {
	...
	/** full constructor */
	public CouponGroup(String dataId, String couponName, Double totalPrice, String tenCoupon, String twentyCoupon, String thirtyCoupon,
			String fiftyCoupon, String hundredCoupon) {
		this.dataId = dataId;
