...
public class CheckOut implements java.io.Serializable{
	...
	public CheckOut(String checkOutId, String contractId, String memberId,
			String branchId, String source, String roomId, String status,
	...
	@Id
	@Column(name = "CHECKOUT_ID", unique = true, nullable = false, length = 17)
