...
public class RoomPrice implements java.io.Serializable {
	...
	/** minimal constructor */
	public RoomPrice(RoomPriceId roomPriceId, String rpName, String rpType, Double discount,
			String recordUser,String theme) {
	...
	/** full constructor */
	public RoomPrice(RoomPriceId roomPriceId, String rpName, Double roomPrice, String packId,
			String rpType, Double discount, Date recordTime, String recordUser, String remark,String theme) {
		this.roomPriceId = roomPriceId;
		this.rpName = rpName;
