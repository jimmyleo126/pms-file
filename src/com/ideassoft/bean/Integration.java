...
public class Integration implements java.io.Serializable {
	...
	/** full constructor */
	public Integration(String logId, String branchId, String checkId, String source, Double fee,
			Integer integragion, String rule, String memberId, Date recordTime) {
		this.logId = logId;
		this.branchId = branchId;
