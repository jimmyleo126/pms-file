...
public class Clean implements java.io.Serializable {
	...
	private static final long serialVersionUID = 3082270169769087782L;
		...
		public Clean(String cleanId, String branchId, Date cleanDate, String roomId,
				String cleanPerson, String recordUser, Date recordTime,
				String timeArea, String remark, String cleanApplyId, Integer restAmount) {
			super();
		...
		@Column(name = "CLEAN_PERSON", nullable = false, length = 80)
		...
		@Column(name = "CLEANAPPLY_ID", nullable = false, length = 17)
