...
public class MemberRank implements java.io.Serializable {
	...
	/** full constructor */
	public MemberRank(String memberRank, String rankName, Short discount, Date recordTime, String status,
			String remark) {
		this.memberRank = memberRank;
		this.rankName = rankName;
		this.discount = discount;
	...
	@Column(name = "RECORD_TIME", insertable = false, updatable = true, length = 7)
