...
public class SmsSendLog implements java.io.Serializable {
	...
	/** full constructor */
	public SmsSendLog(String dataId, String templateId, String branchId, String smsContent, String smsRecipentno, String errorCodes, String recordUser,
			Date recordTime, Date sendTime, String status, String remark) {
		this.dataId = dataId;
	...
	@Column(name = "ERROR_CODES", length = 4)
	...
	/*public SmsSendLog getSendBeforeInfo() {
		SmsSendLog sms = new SmsSendLog();
		sms.setBranchId(branchId);
		sms.setTemplateId(templateId);
		sms.setRecordTime(recordTime);
		sms.setRecordUser(recordUser);
		sms.setRemark(remark);
		sms.setSmsContent(smsContent);
		sms.setSmsRecipentno(smsRecipentno);
		sms.setStatus("1");
		sms.setRemark(remark);
		return sms;
	}*/

	/*public SmsSendLog setSendBeforeInfo(String templateId, String branchId, String smsContent, String smsRecipentno,String recordUser,
