...
public class Event implements Serializable {
	...
	/** full constructor */
	public Event(String evtId, Integer evtIsWarning, Date evtTime,
			String evtSrc, String evtName, String evtCode, String evtContent,
			String evtOperatorId, String evtOperatorIp) {
		this.evtId = evtId;
