...
public class Shift implements java.io.Serializable {
	...
	/** minimal constructor */
	public Shift(String logId, String branchId, String lastShift, String currShift, String lastUser,
			String currUser, String recordUser) {
		this.logId = logId;
	...
	/** full constructor */
	public Shift(String logId, String branchId, String lastShift, String currShift, String lastUser,
			String currUser, Date recordTime, String recordUser, String remark) {
		this.logId = logId;
		this.branchId = branchId;
		this.lastShift = lastShift;
		this.currShift = currShift;
	...
	@Column(name = "LAST_SHIFT", nullable = false, length = 1)
	...
	@Column(name = "CURR_SHIFT", nullable = false, length = 1)
	...
	@Column(name = "LAST_USER", nullable = false, length = 8)
