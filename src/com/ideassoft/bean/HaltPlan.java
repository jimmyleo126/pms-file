...
public class HaltPlan implements java.io.Serializable {
	...
	/** minimal constructor */
	public HaltPlan(String logId, String branchId, String roomId, String haltType, String haltReason,
			Date startTime, Date endTime, String status, String recordUser) {
		this.logId = logId;
	...
	/** full constructor */
	public HaltPlan(String logId, String branchId, String roomId, String haltType, String haltReason,
			Date startTime, Date endTime, String status, Date recordTime, String recordUser, String remark) {
		this.logId = logId;
		this.branchId = branchId;
		this.roomId = roomId;
		this.haltType = haltType;
