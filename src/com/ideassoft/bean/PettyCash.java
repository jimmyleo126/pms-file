...
public class PettyCash implements java.io.Serializable {
	...
	/** minimal constructor */
	public PettyCash(String logId, String branchId, String shift, String cashBox, String handUser,
			String confirmUser, String recordUser) {
		this.logId = logId;
	...
	/** full constructor */
	public PettyCash(String logId, String branchId, String shift, String cashBox, String handUser,
			String confirmUser, Double cashIn, Double cashOut, Double paymentValue, Double shiftValue,
			Double lastShiftvalue, Double currShiftvalue, Double cardBalance, String cards, String depositNo,
			String invoiceNo, String status, Date recordTime, String recordUser, String remark) {
		this.logId = logId;
		this.branchId = branchId;
		this.shift = shift;
		this.cashBox = cashBox;
	...
	@Column(name = "CASH_BOX", nullable = false, length = 4)
