...
public class MaintenanceLog implements java.io.Serializable {
	...
	public MaintenanceLog(String logId, String branchId, String equipment,
			String problemTag, String describe, String recordUser,
			Date recordTime, String status, String remark, String roomId,
			String applicationSource, String repairPerson,
			Date applicationDate, String repairTimearea, Date repairTime,
			String repairApplyId,Date acrepairTime) {
		super();
		this.logId = logId;
	...
	@Column(name = "PROBLEM_TAG", nullable = true, length = 1)
	...
	@Column(name = "REPAIRAPPLY_ID",nullable = false,length=17)
