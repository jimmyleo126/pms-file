...
public class SwitchRoom implements java.io.Serializable {
	...
	/** full constructor */
	public SwitchRoom(String logId, String branchId, String checkId,
			String lastrpId, String lastRoomid, String lastRoomtype,
			Double lastrRoomprice, String currrpId, String currRoomid,
			String currRoomtype, Double currRoomprice, Date recordTime,
			String recordUser) {
		super();
		this.logId = logId;
	...
	@Column(name = "LAST_RPID", nullable = false, length = 3)
	...
	@Column(name = "CURR_RPID", nullable = false, length = 3)
	...
	@Column(name = "LAST_ROOMTYPE", nullable = false, length = 2)
	...
	@Column(name = "CURR_ROOMTYPE", nullable = false, length = 2)
