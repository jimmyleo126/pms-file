...
public class RoleRelation implements java.io.Serializable {
	...
	/** minimal constructor */
	public RoleRelation(String dataId, String roleId, String funcrightId, String datarights, String recordUser,
			String status) {
		this.dataId = dataId;
		this.roleId = roleId;
	...
	@Column(name = "FUNCRIGHT_ID", nullable = false, length = 10)
