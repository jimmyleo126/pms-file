...
<html>
  ...
  <body style="overflow: hidden;">
    <div class="check_wrap_margin check_color">
		<div class="shop_content  margin_gdspage">
			...
			<div class="shop_search" style="height:100%;">
				<form action="" method="post" style="height:100%;">
					...
					<iframe name="goodsIframe" id="goodsIframe" frameborder="0" width="100%" height="100%" src="goodsSale.do" style = "height:560px;"></iframe></div>
				</form>
			</div>
		</div>
	</div>
		...
		$("#goodsIframe").attr("src","gdsaleCondition.do?goodsid="+goodsid+"&goodsname="+goodsname+"&categoryid="+categoryid);
		}
