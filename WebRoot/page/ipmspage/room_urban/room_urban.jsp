...
<html>
  ...
  <body>
   <div class="room_margin"> 
		...
		<label>分店选择</label>
		<input class="urban" placeholder="已选择5家分店"/>
	  </div>
		<form id="cityroom" action="cityroomstatus.do" method="post" target="logFrame">
		<!--  分店名称搜索-->
			<div class="info_show fadeInDown">
				<div class="clearfix">
					<div class="left_area  fl">
						<input type="text" placeholder="搜索分店名称" class="urban">
						<input type="checkbox" name="checkbox" data-labelauty="全选" id="all">
						<button type="button" class="btn_style button_margin close" onclick="submitFrom()">取消</button>
