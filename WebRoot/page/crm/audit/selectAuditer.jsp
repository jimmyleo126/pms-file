	...
	<body oncontextmenu="return true;">
		...
		<script>
			jQuery(document).ready(function() {			
				jQuery("#defaultauditGrid").jqGrid({
					...
					ondblClickRow: function (rowid, iRow, iCol, e) {
		   				...
		   				window.parent.$("#defaultAuditId").val(rowData["STAFF_ID"]);
		   				window.parent.$("#defaultAudit").val(rowData["STAFF_NAME"]);
		   				closeCustom();
					}
				});
			});
			...
			function setGridModels() {
				return [{name: 'STAFF_ID', index: 'STAFF_ID', width:110,align:"center" },
				        {name: 'STAFF_NAME', index: 'STAFF_NAME', width:110, align:"center" }
				   ]
			}
