			...
			/*账单*/
			function changetwo(){
				document.getElementById("customer").innerHTML='<iframe src="' + base_path +'/page/ipmspage/room_statistics/roomlist_bill.jsp?checkid=' + checkid + '" width="100%" height="100%" frameborder=no  scrolling="no"></iframe>'
			}
			/*房租计划*/
