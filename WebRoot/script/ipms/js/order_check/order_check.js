		...
		function changeorderbill(){
			document.getElementById("ifa").innerHTML='<iframe src="' + base_path +'/page/ipmspage/order/bill.jsp" width="100%" height="100%" frameborder=no  scrolling="no"></iframe>'
		}
		/*房租计划*/
		function changeplan(){
			return false;
		...
		/*日志*/
		function changelog(){
			document.getElementById("ifa").innerHTML='<iframe src="' + base_path +'/showLogData.do?checkid='+ checkid +'&type=check" width="100%" height="100%" frameborder=no  scrolling="no"></iframe>'
