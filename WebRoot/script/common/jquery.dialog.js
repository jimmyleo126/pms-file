...
var JDialog = {
	...
	init : function(dialogTitle, iframeSrc, iframeWidth, iframeHeight, fn, isDrag, notitle) {
		...
		$("body").prepend("<div id='jd_dialog' class='ui-jqdialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix fadeInDown  fadeOutUp'></div>");
		...
		_jd_dialog.css("transition", "all 0.15s ease-in-out");
		...
		_jd_dialog_m_h.append("<img src='"+projectName+"/css/ipms/img/backgroundimg/header_clos.png' class='dialog_img' onclick='JDialog.close()'/>");
